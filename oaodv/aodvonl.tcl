...
###  Setting The Initial Positions of Nodes
      ...
      $ns_ at 0.0 "$n11 label J"
      $ns_ at 0.0 "$n12 label K"
      $ns_ at 0.0 "$n13 label L"
      $ns_ at 0.0 "$n14 label M"
      $ns_ at 0.0 "$n15 label N"
      $ns_ at 0.0 "$n16 label O"
      $ns_ at 0.0 "$n17 label P"
      $ns_ at 0.0 "$n18 label Q"
      $ns_ at 0.0 "$n19 label R"
      $ns_ at 0.0 "$n20 label T"
      $ns_ at 0.0 "$n21 label Destination"
      $ns_ at 0.0 "$n22 label U"
