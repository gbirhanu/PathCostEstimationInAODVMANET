...
###  Setting The Initial Positions of Nodes
      ...
      $ns_ at 0.0 "$n6 label Destination"
...
####  Establishing Communication
      ...
      set udp2 [$ns_ create-connection UDP $n2 LossMonitor $n6 0]
      $udp2 set fid_ 1
      ...
      set udp6 [$ns_ create-connection UDP $n3 LossMonitor $n4 0]
      $udp6 set fid_ 1
      ...
      set udp7 [$ns_ create-connection UDP $n4 LossMonitor $n3 0]
      $udp7 set fid_ 1
      ...
      set udp8 [$ns_ create-connection UDP $n4 LossMonitor $n2 0]
      $udp8 set fid_ 1
      ...
      set udp9 [$ns_ create-connection UDP $n6 LossMonitor $n2 0]
      $udp9 set fid_ 1
      ...
      set udp11 [$ns_ create-connection UDP $n2 LossMonitor $n4 0]
      $udp11 set fid_ 1
      ...
      set udp12 [$ns_ create-connection UDP $n6 LossMonitor $n4 0]
      $udp12 set fid_ 1
      ...
      set udp13 [$ns_ create-connection UDP $n4 LossMonitor $n5 0]
      $udp12 set fid_ 1
      set cbr12 [$udp12 attach-app Traffic/CBR]
      $cbr12 set packetSize_ 1000   
      $cbr12 set interopt_ 5
